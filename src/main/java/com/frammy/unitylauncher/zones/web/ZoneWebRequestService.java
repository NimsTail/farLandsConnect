...
public class ZoneWebRequestService {
    ...
    // SET_MILITARY_DEFENSE_SUBTYPE — GH#24 (фидбек 2026-08-14 п.1/4): payload = {"defenseSubtype": "LIVE_DEFENSE"|"AURA"|"SCORCH"|"CROSSBOW"}.
    public enum Action { CREATE, UPDATE_CORNERS, UPDATE_NAME, UPDATE_COLOR, DELETE, UPGRADE_TYPE, ADD_SHAPE, ADD_MEMBER, REMOVE_MEMBER, TRANSFER_OWNERSHIP, SET_MILITARY_SPECIALIZATION, SET_MILITARY_DEFENSE_SUBTYPE }
