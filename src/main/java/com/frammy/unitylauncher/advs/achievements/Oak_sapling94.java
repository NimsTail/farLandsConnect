...
public class Oak_sapling94 extends BaseAdvancement implements HiddenVisibility {
  ...
  public static AdvancementKey KEY = new AdvancementKey(AdvancementTabNamespaces.achievements_NAMESPACE, "oak_sapling94");


  public Oak_sapling94(Advancement parent) {
    super(KEY.getKey(), new FancyAdvancementDisplay(Material.PAPER, "Странник", AdvancementFrameType.TASK, true, true, 1f, 4f ,"", "§5Побывать на координатах ", "§5X=8000 Z=8000"), parent, 1);
  }
}